...
function run_NewSegment(InputParameter)    %   NewSegment LI Zi-Qi 200502
...
%     Parameter.AffineRegularisation=InputParameter.NewSegment.Parameter.AffineRegularisation;    
    ...
    indir_NewSegment_update(indir_t1,outdir_new_segment,Parameter);
end
...
function run_group_wmmask(InputParameter)
    indir_fun = InputParameter.GWM.InDirFunImg;
    otdir_gpmask = InputParameter.GWM.OtDirGroupMask;
    mask_thrsd = InputParameter.GWM.WMthrsd;
    ...
    infodr_get_group_wmmask(indir_fun,otdir_gpmask,mask_thrsd,remove_img,otdir_gpmask_remove,method)
end
